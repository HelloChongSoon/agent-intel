    ...
    <div className="space-y-8 py-4">
      ...
      <div>
        ...
        <p className="mt-4 max-w-3xl text-lg text-zinc-400">
          Direct answer: this page helps consumers see how large {summary.agency.name} is, which agents lead within the agency, and what recent movement and property-mix signals say about its current footprint.
        </p>
      </div>
